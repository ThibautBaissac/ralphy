...
When the plan is written and verified, run: `tsx scripts/complete-plan.ts {{taskId}}`
...
Only after verifying the file contents, run: `tsx scripts/complete-plan.ts {{taskId}}`
