    ...
    <main className="mx-auto max-w-5xl px-6 py-16">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold">Ralphy</span>
        </div>
        <a
          className="text-sm font-medium text-ink-900 underline-offset-4 hover:underline"
          href="https://github.com/vdaubry/ralphy"
        >
          GitHub →
        </a>
      </header>
      ...
      <section className="mt-24 max-w-3xl">
        ...
        <p className="mt-6 text-lg text-ink-900/80 md:text-xl">
          Ralphy turns Claude Code into a multi-project workspace you can drive
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <a
            href="https://github.com/vdaubry/ralphy#installation"
      ...
      <footer className="mt-24 border-t border-ink-900/10 pt-8 text-sm text-ink-900/60">
        <p>
          This page is the sample project that ships with Ralphy&apos;s
          open-source release. Edit it through Ralphy itself — that&apos;s the
          point.
        </p>
      </footer>
    </main>
