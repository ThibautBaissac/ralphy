...
When the plan is written and verified, run: `tsx /home/ubuntu/ralphy/reference/scripts/complete-plan.ts {{taskId}}`
...
Only after verifying the file contents, run: `tsx /home/ubuntu/ralphy/reference/scripts/complete-plan.ts {{taskId}}`