export const DEMO_PROJECT_NAME = 'Ralphy Landing Page';
...
This sample task ships with the Ralphy open-source release so you can see the
full workflow end-to-end: project → task → conversation → real code change.

The repo on disk is a small Next.js (App Router) landing page for Ralphy
...
## Tips for working with Ralphy

- Start a new conversation from this task. Ralphy will inject this doc as
