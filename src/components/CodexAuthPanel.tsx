...
// `~/.codex/auth.json` contents into the textarea, and Ralphy
// persists it under the per-user CODEX_HOME (`~/.config/ralphy/users/
    ...
    <div className="space-y-4" data-testid="codex-auth-panel">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          for OpenAI can run. Ralphy stores it under
          <code className="ml-1">~/.config/ralphy/users/&lt;id&gt;/codex/</code>
