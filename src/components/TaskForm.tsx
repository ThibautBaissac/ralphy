        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              This documentation is saved to <code className="bg-muted px-1 rounded">~/.ralphy/projects/{'{projectId}'}/tasks/task-{'{id}'}.md</code> (outside your repo, survives worktree cleanup) and provides context when starting conversations for this task.
            </p>
          </div>
